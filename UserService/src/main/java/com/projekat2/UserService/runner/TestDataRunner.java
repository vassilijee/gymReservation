...
public class TestDataRunner implements CommandLineRunner {
    ...
    public TestDataRunner(ClientRepository clientRepository, ManagerRepository managerRepository, AdminRepository adminRepository) {
...
//        insert admin
        Admin admin1 = adminRepository.save(new Admin("emalil2@email.com", "ime2", "prezime2", "username2", "password222"));
